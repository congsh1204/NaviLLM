...
torchrun --nnodes=1 --nproc_per_node=8 --master_port 41000 train.py \
    ...
    --batch_size 1 --gradient_accumulation_step 8 --num_steps_per_epoch 2000 --lr 5e-5 --seed 0 --num_epochs 60 \
    ...
    --test_datasets R2R \
    --max_saved_checkpoints 1 --output_dir output/multi_wo_pretrain_v100_5.5 \
